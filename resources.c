...
//=============батарея===============
static const uint8_t bat_alt_img[] PROGMEM = { //полоски заряда акб
  0x81, 0xBD, 0x81, 0xBD, 0x81, 0xBD, 0x81, 0xBD, 0x81, 0xBD
};

static const uint8_t low_bat_img[] PROGMEM = { //эмблемма разряженой батареи
...
//=============средний замер===============
static const uint8_t mid_time_lvl[] PROGMEM = { //прогресс бар
...
//=============тревога===============
static const uint8_t beep_alt_img[] PROGMEM = { //две скобки
  0xFF, 0xAB, 0xD5, 0xFF, 0xDB, 0xE7, 0xBD, 0xC3
};

static const uint8_t beep_alt_off_img[] PROGMEM = { //крестик
  0xFF, 0xBB, 0xD7, 0xEF, 0xD7, 0xBB, 0xFF
};

static const uint8_t beep_alt_waint_img[] PROGMEM = { //звездочка
  0xFF, 0xD7, 0x93, 0xEF, 0x93, 0xD7, 0xFF
};

static const uint8_t beep_alt_vibro_img[] PROGMEM = { //две вертикальные волны
  0xFF, 0xAB, 0xD5, 0xFF, 0xAB, 0xD5, 0xFF
};
//=============щелчки===============
static const uint8_t buzz_alt_img[] PROGMEM = { //динамик
  0xFF, 0xDF, 0xC3, 0xFB, 0xC3, 0xDF, 0xFF
};

static const uint8_t buzz_alt_on_img[] PROGMEM = { //горизонтальная волна
  0xFF, 0xDB, 0xE7, 0xBD, 0xC3, 0xFF, 0xFF
};

static const uint8_t buzz_alt_off_img[] PROGMEM = { //крестик
  0xFF, 0xBB, 0xD7, 0xEF, 0xD7, 0xBB, 0xFF
};
//=============быстрое меню===============
static const uint8_t fast_light_img[] PROGMEM = { //эмблемма "подсветка"
  0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00,
  0x00, 0xE0, 0xE0, 0x00,
...
static const uint8_t fast_flash_img[] PROGMEM = { //эмблемма "фонарик"
  0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x18,
  0x30, 0x60, 0xC0, 0x00,
  0x00, 0xFC, 0xFC, 0x00,
...
static const uint8_t fast_power_img[] PROGMEM = { //эмблемма "кнопки питания"
  0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00,
  0x00, 0x80, 0x00, 0x00,
  0x80, 0xC0, 0xC0, 0x80,
...
static const uint8_t fast_beta_img[] PROGMEM = { //эмблемма "бета"
  0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x80,
  0xE0, 0xF0, 0xF0, 0xF8,
  0x38, 0x38, 0x38, 0x78,
...
//---------------------------------------------//
static const uint8_t fast_up_img[] PROGMEM = { //верхняя плашка быстрого меню - быстрое меню
...
static const uint8_t fast_down_img[] PROGMEM = { //нижняя плашка быстрого меню
...
//=============верхний бар===============
static const uint8_t font_alt_img[] PROGMEM = { //верхний бар
  0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
  0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
  0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
...
//=============отладка===============
static const uint8_t debug_img[] PROGMEM = { //отладка
  0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
...
//=============параметры===============
static const uint8_t stat_img[] PROGMEM = { //параметры
  0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 
...
//===============бета=================
static const uint8_t mesur_img[] PROGMEM = { //бета
  0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 
  0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 
...
//=============логотип===============
static const uint8_t logo_img[] PROGMEM = { //логотип
...
//=============загрузка===============
static const uint8_t load_img[] PROGMEM = { //шкала загрузки
...
//=============режимы===============
static const uint8_t backgr_img[] PROGMEM = { //фон
  0xFF, 0xFF, 0xC3, 0xDB,
  0x81, 0xDB, 0xC3, 0xFF,
  0xC3, 0xBD, 0xBD, 0xC3,
  0xFF, 0x81, 0xEF, 0xEF,
...
static const uint8_t dose_img[] PROGMEM = { //доза
  0xFF, 0xFF, 0x9F, 0xC3,
  0xDD, 0xC1, 0x9F, 0xFF,
  0xC3, 0xBD, 0xBD, 0xC3,
  0xFF, 0xDB, 0xBD, 0xB5,
...
static const uint8_t serch_img[] PROGMEM = { //поиск
  0xFF, 0xFF, 0x81, 0xFD,
  0xFD, 0x81, 0xFF, 0xC3,
  0xBD, 0xBD, 0xC3, 0xFF,
  0x81, 0xEF, 0xF7, 0x81,
...
//=============эмблемма радиации===============
static const uint8_t rad_img[] PROGMEM = { //эмблемма радиации
...
//---------------------------------------------//
static const uint8_t scan_left_img[] PROGMEM = {0xFF, 0x49, 0x49, 0x01, 0xFF, 0x92, 0x92, 0x80}; //левая шкала графика
static const uint8_t scan_right_img[] PROGMEM = {0x01, 0x49, 0x49, 0xFF, 0x80, 0x92, 0x92, 0xFF}; //правая шкала графика
//---------------------------------------------//
static const uint8_t scan_alt_left_img[] PROGMEM = {0xFE, 0x02, 0x02, 0x02, 0xFF, 0x01, 0x01, 0x01, 0xFF, 0x81, 0x81, 0x81}; //левая шкала графика
static const uint8_t scan_alt_right_img[] PROGMEM = {0x02, 0x02, 0x02, 0xFE, 0x01, 0x01, 0x01, 0xFF, 0x81, 0x81, 0x81, 0xFF}; //правая шкала графика
//---------------------------------------------//
static const uint8_t scan_ind_scale_img[] PROGMEM = { //шкала уровня импульсов
...
static const uint8_t scan_ind_img[] PROGMEM = { //уровень импульсов
...
//=============настройки===============
static const uint8_t setings_img[] PROGMEM = { //настройки
...
//  };
//=============тех.символы и буквы===============
static const uint8_t day_img[] PROGMEM = { //д
  0xC0, 0x70, 0x70, 0xC0, 0x00, 0xF0, 0x40, 0xF0
};
static const uint8_t hour_img[] PROGMEM = { //ч
  0x30, 0x40, 0xF0
};
static const uint8_t min_img[] PROGMEM = { //м
  0xF0, 0x20, 0x40, 0x20, 0xF0
};
static const uint8_t colon_img[] PROGMEM = { //:
  0x00, 0x50, 0x00
};
static const uint8_t measur_result_img[] PROGMEM = { //результат
...
static const uint8_t measur_first_img[] PROGMEM = { //замер фона
...
static const uint8_t measur_second_img[] PROGMEM = { //замер образца
  0x24, 0x42, 0x4A, 0x34, 0x00, 0x7C, 0x12, 0x12,
  0x7C, 0x00, 0x7E, 0x04, 0x08, 0x04, 0x7E, 0x00,
  0x7E, 0x4A, 0x4A, 0x00, 0x7E, 0x12, 0x12, 0x0C,
  0x00, 0x00, 0x00, 0x3C, 0x42, 0x42, 0x3C, 0x00,
  0x7E, 0x4A, 0x4A, 0x30, 0x00, 0x7E, 0x12, 0x12,
  0x0C, 0x00, 0x7C, 0x12, 0x12, 0x7C, 0x00, 0x24,
  0x42, 0x4A, 0x34, 0x00, 0x1E, 0x20, 0x20, 0x3E,
  0x60, 0x00, 0x7C, 0x12, 0x12, 0x7C
};
static const uint8_t measur_ok_img[] PROGMEM = { //ок -
  0x3C, 0x42, 0x42, 0x3C, 0x00, 0x7E, 0x18, 0x24,
  0x42, 0x00, 0x08, 0x08, 0x08, 0x08, 0x00
};
static const uint8_t warning_img[] PROGMEM = { //опасность!
  0x3C,
  0x42, 0x42, 0x3C, 0x00,
  0x7E, 0x02, 0x02, 0x7E,
  0x00, 0x7C, 0x12, 0x12,
...
static const uint8_t warning_inv_img[] PROGMEM = { //опасность!
  0x7E, 0x42, 0x3C, 0x3C,
  0x42, 0x7E, 0x00, 0x7C,
  0x7C, 0x00, 0x7E, 0x02,
  0x6C, 0x6C, 0x02, 0x7E,
...
static const uint8_t imp_s_img[] PROGMEM = { //имп/с
  0x7C, 0x20, 0x10, 0x7C,
  0x00, 0x7C, 0x08, 0x10,
  0x08, 0x7C, 0x00, 0x7C,
  0x04, 0x04, 0x7C, 0x00,
