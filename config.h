...
#define ERROR_MASSEGE_TIME  3 //длительность отображения окон ошибок(1..10)(s)
...
#define SAMPLE_ERROR_0_FREQ   2000 //частота семпла 0 ошибки(10..10000)(Hz)
#define SAMPLE_ERROR_0_TIME   200 //длительность звука семпла 0 ошибки(50..500)(ms)
#define SAMPLE_ERROR_0_WAINT  200 //длительность паузы после семпла 0 ошибки(50..1000)(ms)

#define SAMPLE_ERROR_1_FREQ          3000 //частота семпла 1 ошибки(10..10000)(Hz)
#define SAMPLE_ERROR_1_TIME          200 //длительность звука семпла 1 ошибки(50..500)(ms)
#define SAMPLE_ERROR_OVERFLOW_WAINT  600 //длительность паузы перед началом нового круга(50..1000)(ms)
