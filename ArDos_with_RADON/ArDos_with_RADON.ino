/*Arduino IDE 1.8.13
  Версия программы RADON v3.7.2 low_pwr release 18.12.21 специально для проекта ArDos
...
//--------------------------------Отрисовка графика-------------------------------------
void graf_lcd(uint8_t val, uint8_t pos, uint8_t max_g, uint8_t height) //отрисовка графика
{
  if (val > max_g) val = max_g; //ограничивываем максимум
  switch (height) {
    case 2:
...
//{
//  drawLine(pos_bar / 8, start_bar, down_bar,
