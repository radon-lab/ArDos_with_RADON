/*Arduino IDE 1.8.13
  Версия программы RADON v4.4.0 low_pwr release 17.04.24 специально для проекта ArDos
    ...
    if (mainTask != POWER_DOWN_PROGRAM) { //если не инициализация
      ...
      switch (tick_switch) { //основной блок обрабоки данных
        ...
        case TASK_UPDATE_SCREEN: //таймер обновления экрана
          if (!power_sleep && (mainTask != SEARCH_PROGRAM)) { //если не спим и не в режиме поиска
        ...
        if (!alarm_messege()) { //если нет тревоги
          ...
          if (error_switch) {
            ...
            if (mainSettings.sleep_switch && sleep_manual) {
              ...
              if (screen_anim) drawBitmap(32, 0, logbook_ico_img, 9, 8); //logbook
            }
...
#endif
                  break;
                case 1: alarm_massage_show(0, 24); break; //предупреждение
              }
              ...
              switch (dose_mode) {
                case 0: //текущая доза
                  ...
                  switch (alarm_switch) {
                    ...
                    case 2: alarm_massage_show(0, 32); break; //предупреждение
                  }
