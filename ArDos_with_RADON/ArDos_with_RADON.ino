...
uint8_t logbook_measur = 1; //указатель на активность журнала замеров
...
#else
  if (error_switch && !alarm_switch && time_out < time_sec) { //если время вышло, выводим ошибку
#endif
...
void wdt_calibrate(void) //калибровка wdt
{
  ...
  while (wdt_period < 1600 || wdt_period > 1850) {
    ...
    TCNT0 = 176; //устанавливаем счетчик таймера в начальное положение
#else
...
#else
      error_switch = 1; //поднимаем флаг ошибки
#endif
      wdt_period = 1750;
      break;
    }
