/*Arduino IDE 1.8.13
  Версия программы RADON v4.4.3 low_pwr release 02.01.25 специально для проекта ArDos
  ...
  После выключения устройства при низком напряжении акб, включить его можно или передергиванием выключателя питания или зажатием кнопки "OK" более чем на 2 сек.
  ...
  - Иконка "Глаз"
  Статичная - Режим сна заблокирован автоматически
  Мигающая - Режим сна заблокирован в ручную

  - Иконка "Пауза"
  Статичная - Режим "поиск" приостановлен
