/*Arduino IDE 1.8.13
  Версия программы RADON v3.7.0 low_pwr release 13.12.21 специально для проекта ArDos
      ...
      case 5: //select key
        switch (state) {
          case 1:
            ...
            switch (sw) {
              case 0: updateData((uint8_t*)&mainSettings, sizeof(mainSettings), EEPROM_BLOCK_SETTINGS_MAIN, EEPROM_BLOCK_CRC_MAIN); break; //обновляем настройки
#if DEBUG_RETURN
