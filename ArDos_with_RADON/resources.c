...
const uint8_t imp_all_img[] PROGMEM = { //ч/см2
  0x0E, 0x10, 0x10, 0x7E, 0x00, 0x20, 0x10, 0x08, 0x04, 0x00, 0x3C, 0x42,
  0x42, 0x24, 0x00, 0x7E, 0x04, 0x08, 0x04, 0x7E, 0x00, 0x3A, 0x2A, 0x2E
};
