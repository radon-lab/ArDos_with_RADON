...
#define BUTTON_MODE         0 //режим управления устройством(0 - кнопки | 1 - джойстик)
#define BUTTON_BACKL        0 //управление подсветкой кнопок(только для SSD1306 и SH1106)(0 - подсветка не используется | 1 - подсветка используется)
