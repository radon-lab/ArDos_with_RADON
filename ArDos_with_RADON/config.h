...
#define PATTERNS_FRONT  5 //количество патернов счета фона
const uint16_t back_front[PATTERNS_FRONT][3] PROGMEM = { //массив счета фона
  ...
  {800, 6, 380}, //паттерн 2 - порог имп/с | коррекция времени счета | коррекция / 10
  {1300, 12, 1300}, //паттерн 3 - порог имп/с | коррекция времени счета | коррекция / 10
  {22000, 37, 7450} //паттерн 4 - порог имп/с | коррекция времени счета | коррекция / 10
};
