...
#define DEFAULT_AVERAG         10  //длинна буфера усреднения замеров (1..60)
...
#define DET_ERROR_TIME      5   //время после которого можно ститать что счетчик в коротком замыкании(5..255)(s)
