//Язык системы//
#define RUSSIAN //для смены языка необходимо добавить метаданные в файл "languages", по умолчанию доступны - RUSSIAN(русский)
...
#define DEFAULT_PULS           2 //тонкая настройка длинны импульса высоковольтного транса (1..30)
#define DEFAULT_REFERENCE      1.10 //опорное напряжение (0.5..1.5)(v)
#define DEFAULT_GEIGER_TIME    36 //время измерения, для СБМ-20 36 секунд (6..120)(s)
