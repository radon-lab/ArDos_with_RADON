...
#define PATTERNS_FRONT  5 //количество патернов мкР
const uint16_t back_front[PATTERNS_FRONT][3] PROGMEM = { //массив
  {200, 0, 0}, //паттерн 0 - имп/с | время счета | коррекция / 10
  {400, 6, 120}, //паттерн 1 - имп/с | время счета | коррекция / 10
  {800, 6, 380}, //паттерн 2 - имп/с | время счета | коррекция / 10
  {1300, 12, 1300}, //паттерн 3 - имп/с | время счета | коррекция / 10
  {2200, 37, 7450} //паттерн 4 - имп/с | время счета | коррекция / 10
};
