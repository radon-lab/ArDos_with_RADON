...
#define _LIGHT_ON       TCCR2B = 0b00000101; TIMSK2 = 0b00000011; light_switch = light_pwm_on = 1
#define _LIGHT_OFF      TCCR2B = 0b00000101; TIMSK2 = 0b00000011; light_switch = 0 ; light_pwm_on = 1
